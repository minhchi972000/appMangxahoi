...
import com.example.firebase_social_media_app.activity.GroupChatActivity;
...
public class AdapterGroupChatList extends RecyclerView.Adapter<AdapterGroupChatList.MyViewHolder> {
    Context context;
